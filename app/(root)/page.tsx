...
export default function IndexPage() {
  ...
  return (
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 mb-0 md:pb-12 md:pb-20 lg:pb-32 min-h-[calc(100vh-5rem)] flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-2.5 text-center">
          <Image
            src={profileImg}
            height={100}
            width={100}
